	...
	public modificarPersonal() {
		...
		btnGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 ...
				 * */
				Personal personal = new Personal(tablaModificaciones.getValueAt(selectedRow, 0).toString(),txtNombre.getText(), txtApellidoPaterno.getText(), txtMaterno.getText(),
				...
				if(validacion1 || validacion2) {
					...
					JOptionPane.showMessageDialog(getParent(), "REGISTRO AGREGADO CORRECTAMENTE");
					 ...
					 personalABCC pers = new personalABCC();
					 personalDAO.actualizarTabla(pers.tableAltas);
				}//else 
		...
		model.addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) {
				...
				if(! model.isSelectionEmpty()) {
					...
					cboSueldo.setSelectedItem(tablaModificaciones.getValueAt(selectedRow, 7).toString());
					cboDiasTrabajados.setSelectedItem(tablaModificaciones.getValueAt(selectedRow, 8).toString());
